...
const Collages = () => {
  return (
    <>
      <h1 className="text-center font-bold text-4xl lg:mt-32 mb-16 text-slate-700">
        Top Colloges & Admission{" "}
      </h1>
        ...
        <Zoom>
          <div className="card-compact lg:w-72 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              ...
              <p>
                Participants are interconnected via audio and video, enabling
                them to interact both with the instructor and fellow classmates.
                They can talk to the trainer at any time
              </p>
              <div className="mt-5 w-32 mx-auto">
                <Link to='/colleges'>
                  <button className="btn btn-sm hover:bg-[#ee5253] hover:text-white border-[#ee5253]">
                    visit here <FaAngleRight />
                  </button>
                </Link>
              </div>
            </div>
          ...
          <div className="card-compact lg:w-72 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              ...
              <div className="w-32 mx-auto">
                <button className="btn btn-sm mt-5 hover:bg-[#ee5253] hover:text-white border-[#ee5253]">
                  visit here <FaAngleRight />
                </button>
              </div>
            </div>
